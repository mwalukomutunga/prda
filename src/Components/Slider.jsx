    ...
    return ( 
        ...
        <div className="swiper-container swiper-slider swiper-bg swiper-scale-effect" data-loop="true" data-autoplay="4000"
          ...
          <div className="swiper-wrapper">
            <div className="swiper-slide" data-slide-bg="images/slider2.webp">
              <div className="swiper-slide-cover "
              style={{background: 'url(/images/slider2.webp) center', backgroundSize:'cover'}}>
              </div>
            </div>
            <div className="swiper-slide" data-slide-bg="images/slider01.jpg">
              <div className="swiper-slide-cover"
               style={{background: 'url(/images/slider01.jpg) center', backgroundSize:'cover'}}></div>
            </div>  
            ...
            <div className="swiper-slide" data-slide-bg="images/15.jpg">
              <div className="swiper-slide-cover"
                 style={{background: 'url(/images/15.jpg) center', backgroundSize:'cover'}}></div>
            </div>          
        ...
        <div className="shell box-nav box-nav-small box-nav__classic">
          ...
          <div className="wrap-counter">
            ...
            <div className="total-counter">04</div>
          </div>
